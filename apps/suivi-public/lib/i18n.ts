...
export const DICT: Record<Locale, Dict> = {
  fr: {
    ...
    example: 'Exemple : OKP2209260043FIH',
    submit: 'Suivre',
    ...
    notFoundBody:
      'Vérifiez la saisie (format : OKP + 10 chiffres + 3 lettres). Le colis vient peut-être d’être enregistré ; réessayez dans quelques minutes.',
    invalidFormatTitle: 'Ce numéro ne semble pas valide.',
    invalidFormatBody: 'Le format attendu est OKP suivi de 10 chiffres puis de 3 lettres, par exemple OKP2209260043FIH.',
  ...
  en: {
    ...
    example: 'Example: OKP2209260043FIH',
    submit: 'Track',
    ...
    notFoundBody:
      'Check the number (format: OKP + 10 digits + 3 letters). The parcel may have just been registered; try again in a few minutes.',
    invalidFormatTitle: 'This number does not look valid.',
    invalidFormatBody: 'The expected format is OKP followed by 10 digits then 3 letters, e.g. OKP2209260043FIH.',
  ...
  zh: {
    ...
    notFoundBody: '请检查运单号（格式：OKP + 10 位数字 + 3 位字母）。包裹可能刚刚登记，请稍后重试。',
    invalidFormatTitle: '该运单号格式不正确。',
    invalidFormatBody: '正确格式为 OKP 加 10 位数字再加 3 位字母，例如 OKP2209260043FIH。',
    errorTitle: '出现错误。',
  ...
  sw: {
    ...
    example: 'Mfano: OKP2209260043FIH',
    submit: 'Fuatilia',
    ...
    notFoundBody:
      'Angalia nambari uliyoingiza (mfumo: OKP + tarakimu 10 + herufi 3). Huenda mzigo umesajiliwa hivi karibuni; jaribu tena baada ya dakika chache.',
    invalidFormatTitle: 'Nambari hii haionekani sahihi.',
    invalidFormatBody: 'Mfumo unaotarajiwa ni OKP ikifuatiwa na tarakimu 10 kisha herufi 3, mfano OKP2209260043FIH.',
  ...
  ln: {
    ...
    example: 'Ndakisa: OKP2209260043FIH',
    submit: 'Landá',
    ...
    notFoundBody:
      'Talá motango oyo okotisi (fɔrma: OKP + mituya 10 + minkanda 3). Ntango mosusu kolo ekomami kaka sika; meká lisusu na miniti mike.',
    invalidFormatTitle: 'Motango oyo ezali malamu te.',
    invalidFormatBody: 'Fɔrma esengami ezali OKP elandami na mituya 10 mpe na minkanda 3, ndakisa OKP2209260043FIH.',
